...
- [x] Verify build, interactions, and mobile layout
- [x] Refine workflow detail order and remove generic problem/solution copy
- [x] Add Gypson branding, portrait, and GoHighLevel funnel screenshots
- [x] Remove Education and the footer AutomationHub link
