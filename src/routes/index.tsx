...
import { Contact, Footer, FunnelPortfolio, Nav, PortfolioHeader, Results, WorkflowPortfolio } from "@/components/portfolio/Sections";
...
function Index(){return <main><Nav/><PortfolioHeader/><FunnelPortfolio/><WorkflowPortfolio/><Results/><Contact/><Footer/></main>}
